...
title: "OpenClawの統合ランタイムストリーミングのリファクタリング計画 の狙い・設計案・検証ポイントの設計案と論点整理を確認するガイド"
description: "main, subagent, および acp のすべてのランタイムにおいて、バッファリング（結合）、チャンク化、配信順序の制御、およびクラッシュリカバリの挙動を統一するため、単一の共有ストリーミングパイプラインを構築します。"
x-i18n:
