...
title: "macOS リリース"
seoTitle: "OpenClawのmacOS リリース の仕組み・設定手順・運用ガイド"
description: "このアプリは Sparkle による自動更新を同梱しています。リリース ビルドは、Developer ID で署名し、zip 化したうえで、署名済みの appcast エントリと一緒に公開する必要があります。"
x-i18n:
