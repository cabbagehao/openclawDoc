...
title: "Voice Wake"
seoTitle: "OpenClawのVoice Wake機能の設定方法とウェイクワード運用ガイド"
description: "OpenClaw では、wake word は gateway が管理する 1 つのグローバルリスト として扱われます。保存場所（gateway host）、protocol、methodを確認できます。"
x-i18n:
