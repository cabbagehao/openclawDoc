...
**Raspberry Pi OS Lite (64 ビット)** を使用します。ヘッドレス サーバーにはデスクトップは必要ありません。1. [Raspberry Pi Imager](https://www.raspberrypi.com/software/)をダウンロード2. OS を選択します: **Raspberry Pi OS Lite (64 ビット)** 3. 歯車アイコン (⚙️) をクリックして、以下を事前設定します。
...
### USB SSD を使用する (大幅な改善)SDカードは遅くて消耗します。 USB SSD はパフォーマンスを劇的に向上させます
...
| ほとんどの OpenClaw 機能は ARM64 で動作しますが、一部の外部バイナリには ARM ビルドが必要な場合があります。 | ツール | ARM64 ステータス                    | メモ |
| ---------------------------------------------------------------------------------------------------------- | ------ | ----------------------------------- | ---- |
| Node.js                                                                                                    | ✅     | 素晴らしい作品です                  |
| WhatsApp (ベイリーズ)                                                                                      | ✅     | 純粋な JS、問題なし                 |
| 電報                                                                                                       | ✅     | 純粋な JS、問題なし                 |
| gog (Gmail CLI)                                                                                            | ⚠️     | ARM リリースを確認する              |
| クロム (ブラウザ)                                                                                          | ✅     | `sudo apt install chromium-browser` |
