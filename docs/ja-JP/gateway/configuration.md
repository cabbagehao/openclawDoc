---
summary: "構成の概要: 一般的なタスク、クイックセットアップ、完全なリファレンスへのリンク"
read_when:
...
<AccordionGroup>
  <Accordion title="チャネルをセットアップする (WhatsApp、Telegram、Discord など)">
    ...
    - [電報](/channels/telegram) — `channels.telegram`
    - [Discord](/channels/discord) — `channels.discord`
    - [スラック](/channels/slack) — `channels.slack`
    - [信号](/channels/signal) — `channels.signal`
    - [iMessage](/channels/imessage) — `channels.imessage`
    - [Google チャット](/channels/googlechat) — `channels.googlechat`
    - [最重要](/channels/mattermost) — `channels.mattermost`
    - [MS チーム](/channels/msteams) — `channels.msteams`
...
| インフラ                                                                                                                         | `discovery`、`canvasHost`、`plugins`                                | **はい**   | <Note>              |
