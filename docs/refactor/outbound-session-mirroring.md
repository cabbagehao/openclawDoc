...
seoTitle: "OpenClawのアウトバウンド セッション ミラーリングのリファクタリングの目的と変更範囲を整理するガイド"
description: "アウトバウンド送信は、ターゲット チャネル セッションではなく、現在のエージェント セッション (ツール セッション キー) にミラーリングされました。ステータス、コンテキスト、目標を確認できます。"
