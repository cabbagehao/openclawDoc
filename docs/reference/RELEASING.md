---
title: "リリースチェックリスト"
seoTitle: "OpenClawリリース手順と確認項目を整理した運用ガイド"
summary: "npm + macOS アプリの段階的なリリース チェックリスト"
read_when:
description: "リポジトリ ルートの pnpm (ノード 22+) を使用します。タグ付け/公開する前に、作業ツリーをクリーンな状態に保ってください。オペレータートリガー、トラブルシューティング (2.0.0-beta2 リリースのメモ)- npm Pack/publish がハングする。"
x-i18n:
