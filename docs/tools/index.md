...
title: "ツール"
seoTitle: "OpenClaw利用可能ツールの一覧と用途別の使い分けガイド"
description: "OpenClaw は、ブラウザ、キャンバス、ノード、および cron 用の ファーストクラス エージェント ツールを公開します。これらは古い openclaw-* スキルを置き換えるものです。ツールは入力され、シェルは使用されません。"
x-i18n:
