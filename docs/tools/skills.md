...
title: "Skills"
seoTitle: "OpenClawスキル機能の使い方と導入・管理フローガイド"
description: "OpenClaw は、AgentSkills 互換 スキル フォルダーを使用して、エージェントにツールの使用方法を教えます。各スキルは、YAML フロントマターと命令を含む SKILL.md を含むディレクトリです。"
x-i18n:
