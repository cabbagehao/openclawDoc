...
title: "skills"
seoTitle: "OpenClaw CLI: openclaw skills コマンドの使い方と主要オプション・実行例"
description: "スキル（同梱スキル、ワークスペース内スキル、マネージドオーバーライド）を検査し、実行条件を満たしているか、あるいは何が不足しているかを確認します。コマンド一覧を確認できます。"
x-i18n:
