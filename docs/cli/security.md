...
title: "security"
seoTitle: "OpenClaw CLI: openclaw security コマンドの使い方と主要オプション・実行例"
description: "セキュリティツール（監査およびオプションの自動修正）を提供します。関連ドキュメント: - セキュリティガイド: セキュリティ。セキュリティ監査 (audit)、JSON 出力、--fix による変更内容を確認できます。"
x-i18n:
