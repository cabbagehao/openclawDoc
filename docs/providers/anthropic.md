...
title: "Anthropic"
seoTitle: "OpenClawでAnthropic Claudeを使う認証・モデル設定ガイド"
description: "Anthropic Claude を OpenClaw で使うための認証手順をまとめます。API キーと setup-token の使い分け、CLI ログイン、既定モデル設定の流れを確認できます。"
x-i18n:
