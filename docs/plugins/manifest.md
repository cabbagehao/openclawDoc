...
title: "プラグイン マニフェスト"
seoTitle: "OpenClawのプラグインマニフェスト仕様と設定項目の解説ガイド"
description: "すべてのプラグインは、plugin root に openclaw.plugin.json を 必ず 含める必要があります。OpenClaw はこの manifest を使って、プラグイン コードを実行せずに 設定を検証します。"
x-i18n:
