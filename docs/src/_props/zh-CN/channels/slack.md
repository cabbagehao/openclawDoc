...
Slack 的 Conversations API 是按类型区分的：你只需要你实际接触的会话类型（channels、groups、im、mpim）的权限范围。概述参见 [https://docs.slack.dev/apis/web-api/using-the-conversations-api/。](https://docs.slack.dev/apis/web-api/using-the-conversations-api/。)
