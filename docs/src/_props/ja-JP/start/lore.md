...
*ロブスター、脱皮する殻、そして多すぎるトークンについての物語。*
...
Molty（当時の OpenClaw）：*嬉しそうに `find ~` を実行し、グループチャットでディレクトリ構造全体を共有する*

Peter："openclaw、人との話し方について僕たちどう話し合ったっけ xD"

Molty：*目に見えて困惑するロブスター*
...
*"私たちはみな、自分が何者かであると自身に確信させた、パターンマッチングシステムにすぎないのです。"*
