...
* [セッションと複数チャット](#sessions-and-multiple-chats)
  ...
  * [なぜ "LLM request rejected: messages.content.tool\_use.input field required" と表示されるのですか](#why-am-i-seeing-llm-request-rejected-messages-content-tool-use-input-field-required)
...
解除の支援として、こちらから報告していただけると助かります: [https://spa.xfinity.com/check\_url\_status](https://spa.xfinity.com/check_url_status)。
...
<h3 id="why-am-i-seeing-llm-request-rejected-messages-content-tool-use-input-field-required">なぜ "LLM request rejected: messages.content.tool\_use.input field required" と表示されるのですか</h3>
