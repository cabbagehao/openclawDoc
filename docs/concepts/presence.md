...
title: "プレゼンス (稼働状況)"
seoTitle: "OpenClawのプレゼンス管理の仕組みと稼働状態の扱い方ガイド"
description: "プレゼンス情報は、主に macOS アプリの Instances（インスタンス） タブでの表示や、管理者が現在の接続状況を把握するために使用されます。プレゼンスフィールド (表示される項目)、情報のソース (どこから来るか)、1) ゲートウェイ自身のセルフエントリを確認できます。"
x-i18n:
