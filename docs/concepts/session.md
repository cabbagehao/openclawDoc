...
title: "セッション管理"
seoTitle: "OpenClawのセッション管理の仕組みと保持戦略を理解するガイド"
description: "OpenClaw は、エージェントごとに 1 つのメイン（ダイレクトチャット）セッション を主要なものとして扱います。セキュア DM モード (複数人での利用時に推奨)、ゲートウェイが「真実のソース」、データの保存場所を確認できます。"
---
